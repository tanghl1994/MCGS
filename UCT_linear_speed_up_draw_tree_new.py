...
plt.subplot(1,2,1)
file_name_tree = 'UCT_final_linearly_speedup_result_tree_new.txt'
...
for a in alist:
    b = []
    f_tree = open('UCT_final_linearly_speedup_result_tree_new.txt')
    lines = f_tree.readlines()
...
plt.savefig('UCT_linearly_speedup_tree_new.pdf')
